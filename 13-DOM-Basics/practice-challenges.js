...
// setElementText('greeting-text', 'Hello from the inspector!');
// setElementText('nonexistent', 'This will not be set');
...
//     if (el) found.push(el);
//   }
//   console.log(`Found ${found.length} of ${ids.length} requested elements`);
//   return found;
// };
...
// console.log('Total tasks:', getTaskCount());
// console.log('High priority:', getTasksByPriority('high'));
// console.log('Medium priority:', getTasksByPriority('medium'));
// console.log('Low priority:', getTasksByPriority('low'));
// completeTask(0);
// console.log('Task texts:', getTaskTexts());
...
// console.log('Box count:', getColorBoxCount());
// fadeAllBoxes(0.3);
// scaleBox(2, 1.3);
// // resetAllBoxes();
...
// console.log('--- Table Analyzer ---');
// console.log('Table data:', getTableData());
// console.log('Average grade:', getAverageGrade());
// console.log('Names (col 0):', getColumnValues(0));
// console.log('Grades (col 1):', getColumnValues(1));
...
// console.log('Before:', getContentInfo('content-area'));

// richSetContent('content-area',
//   '<h3 style="color: #3949ab">Welcome!</h3><p>This is <em>rich</em> content.</p>');

// appendContent('content-area',
//   '<div class="notification info">New notification added.</div>');

// console.log('After:', getContentInfo('content-area'));
...
// createNotification('success', 'Profile saved successfully!');
// createNotification('error', 'Failed to load data.');
// createNotification('info', 'New updates are available.');
// console.log('Count:', getNotificationCount());

// removeLastNotification();
// console.log('Count after remove:', getNotificationCount());
